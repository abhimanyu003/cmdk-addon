...
CMDK can copy things to your clipboard — URLs, screenshots, QR codes, and calculator results — when you explicitly trigger a copy action.
...
- CMDK **never reads** your clipboard. It only writes to it.
