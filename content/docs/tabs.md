...
CMDK lets you search all your open tabs and jump to any one of them instantly — no scrolling through a tab bar, no hunting with the mouse.
...
CMDK searches across all open windows, not just the current one.
...
If you have the **tabGroups** optional permission enabled, CMDK can also show which group a tab belongs to. See [Tab Groups]({{< relref "tab-groups" >}}) for more.
